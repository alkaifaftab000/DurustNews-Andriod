...
class SearchSlide extends StatefulWidget {
  ...
  const SearchSlide({super.key,required this.searchItem});
  @override
...
class _SearchSlideState extends State<SearchSlide> {
  ...
  Future<void> fetchData() async {
    try {
      ...
      await apiController.getApi(widget.searchItem);
      ...
      builder: (context, constraints) {
        ...
        return cp.CarouselSlider(
          items: apiController.newsList.map((item) {
            return InkWell(
              onTap: () {
                Navigator.push(context,MaterialPageRoute(builder: (context)=> DetailedNewsScreen(news: item)));
              },
              child: Card(
